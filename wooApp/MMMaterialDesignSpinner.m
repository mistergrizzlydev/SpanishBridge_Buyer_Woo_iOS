...
//    [NSTimer scheduledTimerWithTimeInterval:0.9 target:self selector:@selector(setcolor) userInfo:nil repeats:true];
}
...
-(void)setcolor{
    ...
    self.tintColor = [UIColor colorWithHue:hue saturation:saturation brightness:brightness alpha:1];
