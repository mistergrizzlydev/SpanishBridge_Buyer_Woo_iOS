...
class HomeCategoryCell: UITableViewCell, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    var showMore = true;
...
//        }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        if(indexPath.section == 0)
        {
            ...
            cell?.productImageName.textColor = wooSetting.subTextColor
             titleLabel.font = mageWooCommon.setCustomFont(type: .medium, size: 16)
            titleLabel.textColor = wooSetting.subTextColor
            ...
            cell?.productImageName.font = mageWooCommon.setCustomFont(type: .bold, size: 16)
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        return CGSize(width: mainCollectionView.frame.width/2, height:mainCollectionView.frame.height/2)
...
//
//            for i in 0..<recentlyArray.count
//            {
//                UserDefaults.standard.set(recentlyArray[i], forKey: "productsId")
//            }
            // UserDefaults.standard.set(recentlyArray as? NSMutableArray, forKey: "productsId")
